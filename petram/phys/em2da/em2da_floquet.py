...
'''
   ...
   real
'''
class EM2Da_Floquet(Pair, Bdry, Phys):
    def __init__(self,  **kwargs):
        super(EM2Da_Floquet, self).__init__(**kwargs)
        Phys.__init__(self)
    ...
    def attribute_set(self, v):
        ...
        super(EM2Da_Floquet, self).attribute_set(v)
        return v
